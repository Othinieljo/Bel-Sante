        ...
        <div class="dashbord">
            ...
            <div class="dim">
                ...
                <div class="informations">                    
                    ...
                    <h2 style="text-align: center;"><u>Reçu de consultation</u></h2>
                    <div>
                      <p><u><b>Patient :</b></u> <?php echo $consultation['NOM']. " ".$consultation['PRENOM'] ?> </p>
                    </div>
                    <div>
                      <p><u><b>Date de consulation :</b></u> <?php echo $consultation['DATECONSULTATION']?> </p>
                    </div>
                    <div>
                      <p><u><b>Médecin :</b></u><?php echo $consultation['NOMSPECIALISTE']. "  ". $consultation['PRENOMSPECIALISTE']?></p>
                    </div>
                    <div>
                      <p><u><b>Spécialité :</b></u> <?php echo $consultation['SPECIALITEDUSPECIALISTE'] ?></p>
                    </div>
                    <h3>Constantes</h3>
                    <div class="info">
                      <?php echo $consultation['CONSTANTES'] ?>
                    </div>
                    <h3>Observation</h3>
                    <div class="info">
