                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="" style="display: flex;">
                                        <div>
                                            <select name="specialiste" style="width: 150px; height: 50px;" id="">
                                        ...
                                        <input type="button" value="Nouvelle consultation" style="border: none; padding: 10px; margin-left: 5px; height: 35px; border-radius: 10px; font-weight: 500;">
                                    </form>
                                </td>
                            </tr>
                        </table>
